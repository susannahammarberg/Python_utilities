# -*- coding: utf-8 -*-
"""
Created on Tue May 07 13:05:40 2019

@author: Sanna



This mayavi iso surface is actually working 


NOTE: if you have NANs you will see nothing
...
# here i copied a code from gihub where you get help how to costumize the mayavi plot:
...
iutils/plot/mayaviutils.py
@indranilsinharoy indranilsinharoy minor updates 2f23c88 on Jan 16, 2017
726 lines (641 sloc) 29.8 KB
# -*- coding: utf-8 -*-
#-------------------------------------------------------------------------------
# Name:          mayaviutils.py
